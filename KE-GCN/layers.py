...
class Layer(object):
    ...
    def update_with_basis(self, layer_num, weight_basis):
        pass
...
class AutoRelGraphConvolution(Layer):
    ...
    #     """
    #     if layer_num == 1:
    #         layer_str = "layer_one_basis"
    #     else:
    #         layer_str = "layer_two_basis"

    #     new_basis_value = weight_basis[layer_str]

    #     print(self.vars)
    #     self.vars['ent_weights_0'].assign(new_basis_value)
